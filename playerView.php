    ...
    <table class="table table-bordered table-hover " style=" border: 3px solid rgb(32, 12, 27); margin: 20px;">
        ...
        <tbody>
            <?php
                ...
                $playerquery = "SELECT playerid FROM userdetail WHERE username='$username'";
                $player = mysqli_query($connection,$playerquery);
                $playernum = $player->fetch_assoc();
                $id = $playernum["playerid"];
